...
public class Tests {
    ...
    public void testNumbers() {
        ...
        Statistic statistic = TextStatistics.makeNumStatistic(locale, text, BreakIterator.getWordInstance(locale), NumberFormat.getNumberInstance(locale), false);
    ...
    public void testMoney() {
        ...
        Statistic statistic = TextStatistics.makeNumStatistic(locale, text, BreakIterator.getWordInstance(locale), NumberFormat.getCurrencyInstance(locale), true);
    ...
    public void testDate() {
        ...
        Statistic statistic = TextStatistics.makeDateStatistic(locale, text, BreakIterator.getLineInstance(locale), DateFormat.getDateInstance(DateFormat.SHORT, locale));
    ...
    public void testWords() {
        String text = "Now 11/12/20 and it is fifty $50 and 30 $50 203 $1005500 1 1 and 1 all of them at 10/05/2000";
        Locale locale = Locale.US;
        Statistic statistic = TextStatistics.makeWordStatistic(locale, text, BreakIterator.getWordInstance(locale));
    ...
    public void testSentence() {
        ...
        Statistic statistic = TextStatistics.makeWordStatistic(locale, text, BreakIterator.getSentenceInstance(locale));
    ...
    public void testJapan() {
        ...
        statistic = TextStatistics.makeDateStatistic(locale, text, BreakIterator.getLineInstance(locale), DateFormat.getDateInstance(DateFormat.SHORT, locale));
        ...
        Assert.assertEquals(8, statistic.average, 0.0);
        statistic = TextStatistics.makeNumStatistic(locale, text, BreakIterator.getWordInstance(locale), NumberFormat.getCurrencyInstance(locale), true);
